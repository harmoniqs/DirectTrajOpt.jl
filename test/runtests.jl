...
# and are exercised by a dedicated workflow. Match the "benchmark" path
# component exactly so test files like foo_benchmark.jl elsewhere in the
# tree aren't accidentally skipped.
