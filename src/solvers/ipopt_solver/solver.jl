...
"""
   solve!(prob::DirectCollocationProblem;
        init_traj=nothing,
        save_path=nothing,
...
# Arguments
- `prob::DirectCollocationProblem`: The quantum control problem to solve.
...
function remove_slack_variables!(prob::DirectCollocationProblem)
...
function get_num_variables(prob::DirectCollocationProblem)
